...
namespace Tank_Game
{
    public class Sprite
    {
            ...
            public Vector2 ScreenLocation
            {
                get
                {
                    return Camera.ConvertWorldToScreenLocation(worldLocation);
                }
            }
            ...
            public Rectangle ScreenRectangle
            {
                get
                {
                    return Camera.ConvertWorldToScreenLocation(WorldRectangle);
                }
            }
            ...
            public Vector2 ScreenCenter
            {
                get
                {
                    return Camera.ConvertWorldToScreenLocation(worldLocation + RelativeCenter);
                }
            }
            #endregion
            ...
            public virtual void DrawAbsolute(SpriteBatch spriteBatch, Vector2 location)
            {
                spriteBatch.Draw(
                    Texture,
                    location,
            ...
            public virtual void DrawAbsolute(SpriteBatch spriteBatch, Vector2 location, Color color)
            {
                spriteBatch.Draw(
                    Texture,
                    location,
